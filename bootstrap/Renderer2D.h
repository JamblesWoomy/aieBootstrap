...
public:
	...
	virtual void drawSprite(Texture* texture, float xPos, float yPos, float width = 1.0f, float height = 0.0f, float rotation = 0.0f, float depth = 0.0f, float xOrigin = 0.5f, float yOrigin = 0.5f);
